...
1) Converts a csv file into a video
2) The input csv file must contain per timestep cursor position, target position, and target radius data for each trial
...
CSV_NAME = 'trajectory_adv_my_agent_4090000.csv'
