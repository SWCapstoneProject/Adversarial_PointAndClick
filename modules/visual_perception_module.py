...
A new parameter <sigma> has been added to the function in order to tweek values for sigma when training two agents with different human factors.
"""
...
def visual_speed_noise(vel_x, vel_y, sigma=0.15):
